...
#    Updated: 2018/02/22 17:12:00 by thou             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_DIR1	=	src_$(NAME1)/
SRC_DIR2	=	src_$(NAME2)/
SRC_BASE1	=	main.c check.c ft_swap.c ft_push.c ft_rotate.c ft_reverota.c lst.c ft_printab.c print_resultat.c ft_sort.c
SRC_BASE2	=	main.c check.c ft_swap.c ft_push.c ft_rotate.c ft_reverota.c lst.c ft_printab.c
